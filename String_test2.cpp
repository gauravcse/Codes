/***		MAIN FUNCTION TO RUN STRING FUNCTION  WITH REFERENCE COUNT		***/
	...
	OUTER:while(flag) {
		...
		switch(choice) {
			...
			case 3 : {
				...
				cout<<"REFERENCE COUNT OF FIRST STRING OBJECT : "<<s1.get_reference()<<endl<<endl;
				cout<<"DO YOU WANT TO DELETE THE STRING OBJECT ? : ";
				char c;
				cin>>c;
				if(c=='Y') {
					s1.del();
					cout<<"REFERENCE COUNT OF STRING OBJECT : "<<s1.get_reference()<<endl;
					cout<<"CONTENT : "<<s1;
					cout<<"YET NOT DELETED"<<endl;
				}
				cout<<"DO YOU WANT TO DELETE THE STRING OBJECT ? : ";
				cin>>c;
				if(c=='Y') {
					s1.del();
					cout<<"NOW DELETED"<<endl;
				}
